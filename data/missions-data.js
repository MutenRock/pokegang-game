...
const HOURLY_QUEST_POOL = [
  // MEDIUM
  { id:'hq_catch3',   diff:'medium', fr:'Attraper 3 Pokémon',    icon:'caterpie', stat:'totalCaught',      target:3,   reward:{ money:600,  rep:3  } },
  { id:'hq_catch6',   diff:'medium', fr:'Attraper 6 Pokémon',    icon:'caterpie', stat:'totalCaught',      target:6,   reward:{ money:1000, rep:4  } },
  { id:'hq_win2',     diff:'medium', fr:'Gagner 2 combats',      icon:'machop',   stat:'totalFightsWon',   target:2,   reward:{ money:700,  rep:4  } },
  { id:'hq_win4',     diff:'medium', fr:'Gagner 4 combats',      icon:'machop',   stat:'totalFightsWon',   target:4,   reward:{ money:1200, rep:5  } },
  { id:'hq_earn800',  diff:'medium', fr:'Gagner 800₽',           icon:'meowth',   stat:'totalMoneyEarned', target:800, reward:{ money:600,  rep:2  } },
  { id:'hq_earn2000', diff:'medium', fr:'Gagner 2 000₽',         icon:'meowth',   stat:'totalMoneyEarned', target:2000,reward:{ money:1000, rep:4  } },
  { id:'hq_chest1',   diff:'medium', fr:'Ouvrir 1 coffre',       icon:'snorlax',  stat:'chestsOpened',     target:1,   reward:{ money:500,  rep:2  } },
  { id:'hq_sold3',    diff:'medium', fr:'Vendre 3 Pokémon',      icon:'abra',     stat:'totalSold',        target:3,   reward:{ money:800,  rep:2  } },
  { id:'hq_event1',   diff:'medium', fr:'Compléter 1 événement', icon:'chansey',  stat:'eventsCompleted',  target:1,   reward:{ money:700,  rep:3  } },
  // HARD
  { id:'hq_catch15',  diff:'hard',   fr:'Attraper 15 Pokémon',   icon:'caterpie', stat:'totalCaught',      target:15,  reward:{ money:3500, rep:12 } },
  { id:'hq_catch25',  diff:'hard',   fr:'Attraper 25 Pokémon',   icon:'caterpie', stat:'totalCaught',      target:25,  reward:{ money:5000, rep:16 } },
  { id:'hq_win8',     diff:'hard',   fr:'Gagner 8 combats',      icon:'machoke',  stat:'totalFightsWon',   target:8,   reward:{ money:4000, rep:14 } },
  { id:'hq_win12',    diff:'hard',   fr:'Gagner 12 combats',     icon:'machamp',  stat:'totalFightsWon',   target:12,  reward:{ money:6000, rep:18 } },
  { id:'hq_earn6000', diff:'hard',   fr:'Gagner 6 000₽',         icon:'meowth',   stat:'totalMoneyEarned', target:6000,reward:{ money:3000, rep:10 } },
