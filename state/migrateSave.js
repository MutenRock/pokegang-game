...
export function migrateSave(saved, deps) {
  ...
  if (!merged.gang.competition || typeof merged.gang.competition !== 'object') {
    ...
    if (!Array.isArray(comp.defenseTeam) || comp.defenseTeam.length !== 6)
    ...
    if (!comp.wins   || typeof comp.wins   !== 'object') comp.wins   = { attack: 0, defense: 0 };
    if (!comp.losses || typeof comp.losses !== 'object') comp.losses = { attack: 0, defense: 0 };
    if (!comp.raidCooldowns || typeof comp.raidCooldowns !== 'object') comp.raidCooldowns = {};
